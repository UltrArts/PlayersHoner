                        ...
                        <div class="row">
                            ...
                            <div class="col-7 d-flex align-items-center">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title">  {{number_format($credit_total, 2, '.', ',') .' Mzn'}} </h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 d-flex align-items-center">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title">  {{number_format($debit_total, 2, '.', ',') .' Mzn'}} </h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 d-flex align-items-center">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title"> {{number_format($trans_cred_last_month, 2, '.', ',') .' Mzn'}} </h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 d-flex align-items-center">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title"> {{number_format($trans_deb_last_month, 2, '.', ',') .' Mzn'}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
