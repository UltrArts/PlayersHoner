            ...
            <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                ...
                <li class="nav-item dropdown hidden-caret">
                    ...
                    <ul class="dropdown-menu notif-box" aria-labelledby="navbarDropdown">
                        ...
                        <li>
                            <a class="see-all" href="javascript:void(0);"> <strong>Ver todas notficações</strong> <i class="la la-angle-right"></i> </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li>
                            ...
                            <form action="{{ route('logout')}}" method="POST">
                                ...
                                <button type="submit" class="dropdown-item"><i class="la la-power-off text-danger la-lg"></i> Logout</button>
                            </form>
                        </ul>
                        <!-- /.dropdown-user -->
                    </li>
